...
class Event(models.Model):
    ...
    cover_image = models.ImageField(upload_to="events/", null=True, blank=True, validators=[ImageFileValidator()])
    status = models.CharField(max_length=20, choices=Status.choices, default=Status.DRAFT)
    is_online = models.BooleanField(default=False)
    capacity = models.PositiveIntegerField()
    sales_cutoff_hours = models.PositiveIntegerField(
        null=True,
        blank=True,
    ...
    def save(self, *args, **kwargs):
        ...
        if self.cover_image and hasattr(self.cover_image, "file"):
            optimize_image(self.cover_image, "event_cover")
